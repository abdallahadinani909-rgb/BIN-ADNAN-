...
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*𝐁𝐈𝐍 𝐀𝐃𝐍𝐀𝐍 𝐕𝐈𝐄𝐖𝐄𝐃✅*",
...
MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || "https://files.catbox.moe/chzcqk.jpeg",
...
BOT_NAME: process.env.BOT_NAME || "𝐁𝐈𝐍 𝐀𝐃𝐍𝐀𝐍",
// 𝗯𝗼𝘁 𝗻𝗮𝗺𝗲 𝗳𝗼𝗿 𝗺𝗲𝗻𝘂

STICKER_NAME: process.env.STICKER_NAME || "𝐁𝐈𝐍 𝐀𝐃𝐍𝐀𝐍",
// 𝘀𝘁𝗶𝗰𝗸𝗲𝗿 𝗽𝗮𝗰𝗸 𝗻𝗮𝗺𝗲
...
OWNER_NAME: process.env.OWNER_NAME || "𝐁𝐈𝐍 𝐀𝐃𝐍𝐀𝐍",
// 𝗯𝗼𝘁 𝗼𝘄𝗻𝗲𝗿 𝗻𝗮𝗺𝗲

DESCRIPTION: process.env.DESCRIPTION || "*> © 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 𝐁𝐈𝐍 𝐀𝐃𝐍𝐀𝐍*",
// 𝗯𝗼𝘁 𝗱𝗲𝘀𝗰𝗿𝗶𝗽𝘁𝗶𝗼𝗻

ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/chzcqk.jpeg",
// 𝗮𝗹𝗶𝘃𝗲 𝗺𝗲𝘀𝘀𝗮𝗴𝗲 𝗶𝗺𝗮𝗴𝗲

LIVE_MSG: process.env.LIVE_MSG || "> 𝐁𝐈𝐍 𝐀𝐃𝐍𝐀𝐍",
// 𝗮𝗹𝗶𝘃𝗲 𝗺𝗲𝘀𝘀𝗮𝗴𝗲
